<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="content" label="服务城市">
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="服务城市:" :label-width="formLabelWidth">
...
<script>
import {getScopes, addScope, updateScope, deleteScope} from '@/api/maintain'
export default {
  data() {
    return {
      formLabelWidth: '80px',
  ...
  methods: {
    ...
    updateForm(){
      if(this.index == -1){
        ...
        // 编辑城市
        updateScope(this.form).then((res)=>{
          if(res.code === 20000){
    ...
    handleSizeChange(limit){
      ...
      getScopes(this.params).then((res)=>{
        if(res.code == 20000){
          this.list = res.data;
